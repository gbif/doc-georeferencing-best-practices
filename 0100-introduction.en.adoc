...
.40 digits: You are optimistic about our understanding of the nature of distance itself.<br />What the number of digits in coordinates would imply if precision was misconstrued to imply geographic extent. From https://xkcd.com/2170/[xkcd^].
