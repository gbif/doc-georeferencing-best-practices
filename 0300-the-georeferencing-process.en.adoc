...
3.1.1.1 Project Preparation Phase
...
3.1.1.2 Data Preparation Phase
...
3.1.1.4 Project Follow-up Phase
...
3.2.4.2 Using Date Constraints
...
3.2.4.3 Using Collector Itineraries
...
3.2.4.5 Using Geological Context
...
3.4.2.1 Uncertainty in Paper Map Measurements
...
3.4.2.2 Uncertainty in Digital Map Measurements
...
3.4.2.3 Using OpenStreetMap™, Google Maps™, and Google Earth™
...
3.4.2.4 Uncertainties in Marine Maps
...
3.4.2.5 Uncertainty due to GPS
...
3.4.2.6 Uncertainty due to using previously georeferenced localities
...
3.4.3 Uncertainty Related to Coordinate Precision
...
3.4.5 Uncertainty Related to Heading
...
3.4.6 Uncertainty Related to Offset Precision
