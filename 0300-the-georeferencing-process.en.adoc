...
* Georeferenced occurrence records get shared via global biodiversity networks such as [https://doi.org/10.1525/bio.2010.60.4.2VertNet (Guralnick & Constable 2010)^] and https://www.gbif.org/[GBIF^].
