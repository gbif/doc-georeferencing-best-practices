...
[[anchor-151]]**Figure 13. **A snapshot of the _*Georeferencing Calculator*_ (Wieczorek & Wieczorek 2020) showing ¤<<maximum uncertainty distance,maximum uncertainty>>¤ calculation for the ¤<<locality>>¤: ‘_10 mi E (by air) Bakersfield_’.
